...
let GiftCardTransactionService = class GiftCardTransactionService {
    ...
    utilsService;
    constructor(giftCardTransactionModel, utilsService) {
    ...
    async findAll(query, id_store) {
        ...
        if (search_word) {
            where[sequelize_2.Op.or] = [
                ...
                { $id_gift_card$: { [sequelize_2.Op.like]: `%${search_word}%` } },
            ];
        }
...
exports.GiftCardTransactionService = GiftCardTransactionService = __decorate([
    ...
    __param(0, (0, sequelize_1.InjectModel)(gift_card_transaction_entity_1.GiftCardTransaction)),
