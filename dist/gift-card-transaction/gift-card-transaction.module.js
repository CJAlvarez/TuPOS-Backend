...
const gift_card_transaction_controller_1 = require("./gift-card-transaction.controller");
...
exports.GiftCardTransactionModule = GiftCardTransactionModule = __decorate([
    (0, common_1.Module)({
        imports: [
            sequelize_1.SequelizeModule.forFeature([gift_card_transaction_entity_1.GiftCardTransaction, admin_entity_1.Admin]),
            auth_module_1.AuthModule,
            jobs_module_1.JobsModule,
            utils_module_1.UtilsModule,
        ],
        controllers: [gift_card_transaction_controller_1.GiftCardTransactionController],
        providers: [gift_card_transaction_service_1.GiftCardTransactionService],
        exports: [gift_card_transaction_service_1.GiftCardTransactionService],
    })
