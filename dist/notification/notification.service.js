...
let NotificationService = class NotificationService {
    notificationModel;
    utilsService;
    constructor(notificationModel, utilsService) {
    ...
    async findAll(query, id_store) {
        ...
        if (search_word) {
            where[sequelize_2.Op.or] = [
                ...
                { $subject$: { [sequelize_2.Op.like]: `%${search_word}%` } },
            ];
        }
...
exports.NotificationService = NotificationService = __decorate([
    ...
    __param(0, (0, sequelize_1.InjectModel)(notification_entity_1.Notification)),
