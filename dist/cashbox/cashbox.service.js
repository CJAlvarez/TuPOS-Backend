...
let CashboxService = class CashboxService {
    cashboxModel;
    utilsService;
    constructor(cashboxModel, utilsService) {
        this.cashboxModel = cashboxModel;
    ...
    async findAll(query, id_store) {
        ...
        if (search_word) {
            where[sequelize_2.Op.or] = [
                ...
                { $opening_amount$: { [sequelize_2.Op.like]: `%${search_word}%` } },
            ];
        }
...
exports.CashboxService = CashboxService = __decorate([
    ...
    __param(0, (0, sequelize_1.InjectModel)(cashbox_entity_1.Cashbox)),
